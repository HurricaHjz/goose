...
# Modify list `a`
a.append(5)
print("\nAfter modifying a (a.append(5)):")
print(f"a = {a}")
print(f"l1 = {l1}  # l1 should remain unchanged")
print(f"l2 = {l2}  # l2 should reflect changes to `a` as a nested reference")

# Print final results
print("\nFinal Result:")
print(f"l1 = {l1}  # Does not change after modifying `a`")
print(f"l2 = {l2}  # Changes after modifying `a` because it references `a`")

result = []
for i in range(3):
            prob_results = [0]
            prob_results[0] += i
            result.append((i,prob_results))
